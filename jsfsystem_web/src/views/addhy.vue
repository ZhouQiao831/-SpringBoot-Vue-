  ...
  <div class="global">
    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="年龄">
        ...
        <el-date-picker v-model="form.createTime" value-format="yyyy-MM-dd" placeholder="办卡时间"></el-date-picker>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    geteight() {
      var funk = "";
      for (var i = 0; i < 8; i++) {
        funk += Math.floor(Math.random() * 10);
      }
      this.form.cardno = funk;
    },
    async add() {
      this.form.shengyutime = this.form.buytime;
      const res = await service.post("/huiyuan/add", this.form);
      console.log(res);
      if(res.code == 200){
